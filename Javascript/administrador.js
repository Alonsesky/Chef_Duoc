      ...
      datos.forEach((producto, i) => {  
        ...
        cartas +=  `
          <tr data-product-id="${id}"> 
            <td><input id="input-nombre" class="form-control" type="text" placeholder="${title}" style="color: #013f6b"></td>
            <td><input id="input-precio" class="form-control" type="number" placeholder="${precio}" style="color: #013f6b"></td>
            <td>
              <select id="input-categoria" class="form-select" style="color: #0560a1">
                <option value="1" ${categoria == '1' ? 'selected' : ''}>Menu</option>
                <option value="2" ${categoria == '2' ? 'selected' : ''}>Bebestible</option>
              </select>
            </td>
            <td>
              <textarea id="input-descripcion" class="form-control" style="color: #013f6b" rows="3" placeholder="${description}"></textarea>
            </td>
